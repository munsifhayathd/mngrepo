...
export default function SettingsPage() {
  const [settings, setSettings] = useState({
    companyName: "MNG Survey",
    emailNotifications: true,
    smsNotifications: false,
    autoRenewalReminder: 30,
    defaultProject: "Land Development Survey",
  });
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="defaultProject">Default Project Type</Label>
              <select
                id="defaultProject"
              ...
              >
                <option value="Land Development Survey">Land Development Survey</option>
                <option value="Infrastructure Mapping">Infrastructure Mapping</option>
                <option value="Resource Sector Survey">Resource Sector Survey</option>
